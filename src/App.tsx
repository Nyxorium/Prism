...
async function refreshStoredSession(
  ...
  try {
    const res = await fetch(
      `${stored.pdsUrl}/xrpc/com.atproto.server.refreshSession`,
      {
        method: 'POST',
...
export default function App() {
  ...
  const [handle, setHandle] = useState(
    () => localStorage.getItem('pridelabeller:handle') ?? '',
  )
  ...
  const detectPds = async (targetHandle: string) => {
    ...
    try {
      ...
      if (resolveRequestId.current !== requestId || !pdsAutoFilled.current)
        return
      setPdsUrl(resolved)
      ...
      setPdsDetectError(
        err instanceof ResolveError
          ? err.message
          : "Couldn't auto-detect your provider.",
      )
    } finally {
    ...
    <div className="app">
      <header className="header">
        <div className="header-inner">
          ...
          <span className="tagline">
            Add pride labels to your profile using{' '}
            <a
              href="https://bsky.app/profile/pridelabeller.bsky.social"
              target="_blank"
              rel="noreferrer">
              pridelabeller.bsky.social
            </a>
          </span>
        </div>
      </header>
      ...
      <main className="main">
        ...
        {step === 'login' && (
          <div className="card">
                  ...
                  <div className="pds-row">
                    <input
                      ...
                      placeholder={
                        pdsDetecting
                          ? 'Detecting…'
                          : 'Auto-detected from your handle'
                      }
                      value={pdsUrl}
                      onChange={e => {
            ...
            <p className="disclaimer">
              Your credentials are used only to verify your identity and are
              never stored outside of your device.
            </p>
          </div>
        )}
        ...
        {step === 'success' && (
          <div className="card">
            ...
            <p className="card-subtitle">
              Your labels have been updated. They may take a moment to appear on
              your profile.
            </p>
            <button
              className="btn"
      ...
      <footer className="footer">
        <p>
          PrideLabeller ·{' '}
          <a
            href="https://github.com/Nyxorium/Prism"
            target="_blank"
            rel="noreferrer">
            Source code
          </a>
