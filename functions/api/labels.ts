...
export const onRequestPost: PagesFunction<Env> = async ({request, env}) => {
  ...
  if (body.accessJwt && body.did) {
    ...
    try {
      ...
      if (
        ...
        return errorResponse(
          origin,
          "Couldn't reach your PDS. Check the URL in Advanced settings and try again.",
          503,
        )
      }
      return errorResponse(
        origin,
        "Invalid credentials. If your account isn't on Bluesky, make sure to set your provider under Advanced.",
        401,
      )
    }
  ...
  try {
    ...
    return Response.json(
      {
        did,
        labels: activeLabels,
        ...(refreshJwt ? {accessJwt, refreshJwt} : {}),
      },
    ...
    return errorResponse(
      origin,
      'Something went wrong fetching your labels. Please try again.',
      500,
    )
  }
}
